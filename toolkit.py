...
print ("Just Run This Tool")
print ("And Make Your Termux As A Hacking Mechine")
print ("This Tool Will Install 50+ Advanced and Basic tools")
print ("--------------------------------------------------------------------------")
print ("")
print("(1)Start Installing")
print("(2)Exit")
print("")
choice = input("\033[93mSelect Your Options[1/2] : ")
if choice == '2' : sys.exit()
if choice == '1' : os.system ("clear")
os.system ("cd")
